...
namespace Assembly.Metro.Controls.PageTemplates.Games.Components.MetaData
{
	...
	public class RawData : ValueField
	{
		...
		public RawData(string name, uint offset, long address, string value, int length, uint pluginLine, string tooltip,string tra,string tooltipTra, FileSegmentGroup metaArea, TagDataCommandState tagCommandState)
		...
		public RawData(string name, uint offset, string format, long address, string value, int length, uint pluginLine, string tooltip, string tra,string tooltipTra, FileSegmentGroup metaArea, TagDataCommandState tagCommandState)
			: base(name, offset, address, pluginLine, tooltip,tra, tooltipTra)
		{
			_value = value;
			_length = length;
		...
		{
			return new RawData(Name, Offset, FieldAddress, _value, _length, PluginLine, ToolTip,Tra, TooltipTra, _metaArea, _tagCommandState);
		}
