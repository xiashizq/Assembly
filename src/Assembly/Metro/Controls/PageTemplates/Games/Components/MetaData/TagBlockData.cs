...
namespace Assembly.Metro.Controls.PageTemplates.Games.Components.MetaData
{
	...
	public class TagBlockData : ValueField
	{
		...
		public TagBlockData(string name, uint offset, long address, uint elementSize, int align,
			bool sort, uint pluginLine, string tooltip, string tra,string tooltipTra, FileSegmentGroup metaArea, TagDataCommandState tagCommandState)
		...
		{
			var result = new TagBlockData(Name, Offset, FieldAddress, ElementSize, Align, Sort, PluginLine, ToolTip,Tra, TooltipTra, _metaArea, _tagCommandState);
