...
namespace Assembly.Windows
{
    ...
    public partial class Home
    {
        ...
        private void menuTranslation_Click(object sender, RoutedEventArgs e)
        {
            AddTabModule(TabGenre.Translation);
        }

        private void menuGPT_Click(object sender, RoutedEventArgs e)
        {
            AddTabModule(TabGenre.GPT);
        }
        ...
        public void AddTabModule(TabGenre tabG, bool singleInstance = true)
        {
            ...
            switch (tabG)
            {
                ...
                case TabGenre.TagListings:
                    ...
                    break;
                case TabGenre.Translation:
                    tab.Title = "Translation Setting";
                    tab.Content = new Translation();
                    break;
                case TabGenre.GPT:
                    tab.Title = "GPT Setting";
                    tab.Content = new Gpt();
                    break;
            }
